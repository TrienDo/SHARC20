...
jQuery.fn.fileExif = function(fncCallback) {
    ...
    reader.onload = function(event) {
        ...
        fncCallback(EXIF.readFromBinaryFile(binaryResponse));

    };

    // TODO: Use the slice method to read just the first 128kb
    // of the image, else reading large images will slow down stuff
