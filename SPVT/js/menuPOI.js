                ...
                Save: function() {
                    ...
                    {                    
                        ...
                        if(isFromPhoto && $('#includeGPSPhoto').is(':checked'))//include the GPS taggged photo as the first media for POI
                        {
                            ...
                            curMedia = new SharcMediaExperience(0, curMediaBank, "POI", -1, curProject.id, $("#mediaCaptionPOI").val(), "", false, true,0, 0);//trick: if curMedia.entityId = -1 then upload media                      
                        }
...
function addMarkerPOIClickEvent(marker)
{
    google.maps.event.addListener(marker, 'click', function() 
    {
        ...
        else{//This is a response for a new location
            showResponseAsPOI(marker.rid);   
        }
    });
}
