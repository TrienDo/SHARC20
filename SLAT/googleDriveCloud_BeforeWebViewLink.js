  ...
  reader.onload = function(e) {
    ...
    request.execute(function(resp) {
            ...
            if (resp.error == null) {
                ...
                //image
                document.getElementById("uploadedImage").src = "http://drive.google.com/uc?export=download&id=" + resp.id;
                
                //audio
                /*
                var audio = document.getElementById('audioControl');
                var source = document.getElementById('uploadedAudio');
                source.src= "http://drive.google.com/uc?export=download&id=" + resp.id;
